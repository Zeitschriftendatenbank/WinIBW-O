var MISC, O;
TestRunner.add("O_parseField_pica3", function() {
    ...
    var parsed1 = O.parseField(line1);
    ...
    var parsed2 = O.parseField(line2);
...
TestRunner.add("O_parseField_picaplus", function() {
  MISC.format('P');
  var out = O.parseField("039E ƒbfƒaFortsetzung vonƒ9942987667ƒ8--Cbvz");
